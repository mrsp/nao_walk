...
std::vector< std::string> KDeviceLists::generateSensorKeys()
{
    ...
    fSensorKeys.resize(NUMOFSENSORS);
    // Inertial sensors
    fSensorKeys[ACC + AXIS_X] = preFix + "InertialSensor/AccelerometerX/Sensor/Value";
    fSensorKeys[ACC + AXIS_Y] = preFix + "InertialSensor/AccelerometerY/Sensor/Value";
    fSensorKeys[ACC + AXIS_Z] = preFix + "InertialSensor/AccelerometerZ/Sensor/Value";
    fSensorKeys[GYR + AXIS_X] = preFix + "InertialSensor/GyroscopeX/Sensor/Value";
    fSensorKeys[GYR + AXIS_Y] = preFix + "InertialSensor/GyroscopeY/Sensor/Value";
    fSensorKeys[GYR + AXIS_Z] = preFix + "InertialSensor/GyroscopeZ/Sensor/Value";

...
public:
    ...
    void Control(boost::circular_buffer<KVecFloat3> & ZmpBuffer, float CoMMeasuredX, float CoMMeasuredY, float CoMVelX, float CoMVelY, float ZMPMeasuredX, float ZMPMeasuredY);

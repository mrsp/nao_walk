#ifndef __LIPMTHREAD_H__
#define __LIPMTHREAD_H__
...
private:
    ...
    KMath::KMat::GenMatrix<float, 4, 1>  Lcom;
    KVecFloat2 error, y_;
...
public:
    ...
    DynamicsLIPM(RobotParameters &robot);
...
public:
    ...
    void reset();
    KalmanLIPM(RobotParameters &robot);
...
public:
    ...
    DynamicsLIPM DynamicsX, DynamicsY;
    KalmanLIPM KalmanX, KalmanY;
    LIPMThread(RobotParameters&);
